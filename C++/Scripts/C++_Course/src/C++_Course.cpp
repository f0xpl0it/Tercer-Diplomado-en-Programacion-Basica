...
void conversorTemperatura(){
	...
	// Output - Input
	cout << "Ingrese temperatua en grados Celcius: ";
	cin >> degree;
...
// Ejercicio 3: Conversi�n m�ltiple de unidades
...
// Ejercicio 4: Ecuaci�n cuadr�tica (f�rmula general)
void formulaGeneral(){
	//Variables
